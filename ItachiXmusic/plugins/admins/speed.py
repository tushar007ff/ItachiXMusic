...
from ItachiXMusic.utils import AdminRightsCheck
from ItachiXMusic.utils.database import is_active_chat, is_nonadmin_chat
from ItachiXMusic.utils.decorators.language import languageCB
from ItachiXMusic.utils.inline import close_markup, speed_markup
...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    try:
        await ItachiXMusic.speedup_stream(
            chat_id,
            file_path,
            speed,
            playing,
